...
namespace math {
    double CNormalizeAngle(const double angle) {
    ...
    void CartesianFrenetConverter::cartesian_to_frenet(
        ...
        // std::cout<<"123  "<<ptr_d_condition->at(0)<<std::endl;
        ...
        // std::cout<<"456  "<<ptr_d_condition->at(1)<<std::endl;
        ...
        // std::cout<<"789  "<<ptr_d_condition->at(2)<<std::endl;
        ptr_s_condition->at(0) = rs;
        // std::cout<<"456  "<<ptr_s_condition->at(0)<<std::endl;
        ptr_s_condition->at(1) = v * cos_delta_theta / one_minus_kappa_r_d;
        // std::cout<<"789  "<<ptr_s_condition->at(1)<<std::endl;
        ...
        ptr_s_condition->at(2) =
            ...
            one_minus_kappa_r_d;
        // std::cout<<"000  "<<ptr_s_condition->at(2)<<std::endl;
        return;
    }
    ...
    void CartesianFrenetConverter::frenet_to_cartesian(
        ...
        *ptr_theta = CNormalizeAngle(-delta_theta + rtheta);
    ...
    double CartesianFrenetConverter::CalculateTheta(const double rtheta,
                                                    ...
                                                    const double l,
                                                    const double dl) {
        return CNormalizeAngle(rtheta - std::atan2(dl, 1 - l * rkappa));
    }
