...
namespace math {
    ...
    void gussPointToFLU(const had_map::MapPoint &originPoint,
        ...
        relativePoint.setHeading(NormalizeAngle(goalPoint.heading() - originPoint.heading() + M_PI / 2.0));
    }
    ...
    void gussPointToRFU(const had_map::MapPoint &originPoint,
        ...
        relativePoint.setHeading(NormalizeAngle(goalPoint.heading() - originPoint.heading()));
    }
