...
public:
    struct wayPointSamplerConfig{
        ...
        float setMinSpeed;
        wayPointSamplerConfig(): sampleMaxPointsNumEachLevel(7),
    ...
    struct SpeedAndKappaConfig{
        ...
        SpeedAndKappaConfig(): speed_centric_acceleration_limit(0.8),
                               min_reduce_acc(-0.3),
                               reduce_acc_cost(2e6)
        {}
    };
    ...
    struct PathDecisionConfig{
        ...
        PathDecisionConfig(): haslap_solid_line_cost(1e8)
                {}
    };
