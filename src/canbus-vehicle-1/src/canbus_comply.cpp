...
void CanbusComply::VehicleComm()
{
    ...
    //if(mCanMsg.hookStatus == 4 && mCanMsg.palletStatus != 3) can284[2] = 0x04;
    if(mCanMsg.hookStatus == 3 && mCanMsg.palletStatus != 4) can284[2] = 0x08;
    ...
    //int hook_cmd = 0;
    //ros::param::get("/canbus/hook", hook_cmd);
    //can284[2] = hook_cmd;
    SendVehicleControlCmd(0x284, can284);
...
void CanbusComply::RecvCanData(const can_msgs::Frame &msg)
{
    ...
    case 0x185: {
        ...
        mCanMsg.vehicleSpeed = spd * 3/24.2/60 * M_PI * 0.7/3.6;
