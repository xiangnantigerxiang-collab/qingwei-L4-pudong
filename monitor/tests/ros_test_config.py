...
- FENCE_PATH 指向双围栏 fixture 目录(正方形含坏行 + 顺时针三角形,
  验证 x/y/heading 解析、坏行跳过与 2m 内缩几何)
...
CONFIG = {
    ...
    "FENCE_PATH": "$MON/tests/fence_fixture",
    "SCAN_EXTRINSICS": {
    ...
    "LAYERS": {
        ...
        "loadpos": True, "stoppose": True, "map": False, "fence": True,
        "scan": True, "cloud": True, "grid": False,
    },
}
